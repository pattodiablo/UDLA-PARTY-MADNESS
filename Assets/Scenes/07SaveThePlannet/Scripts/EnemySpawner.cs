...
public class EnemySpawner : MonoBehaviour
{
    ...
    public float screenTopOffset = -5f; // Offset desde la parte superior de la pantalla para que los enemigos aparezcan
    ...
    void SpawnEnemy()
    {
        ...
        Vector3 spawnPosition = new Vector3(Random.Range(-10f, 10f), mainCamera.transform.position.x + screenTopOffset, 0f);
